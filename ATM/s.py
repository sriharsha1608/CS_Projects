...
# def operations_atm(client_socket,passwords):
...
while True:
    ...
    try:
        while True:
            ...
            print("us :",received_username)
            print("pass :",received_password)
        ...
        print(f"Connection from {client_address} closed by the client.")
        client_socket.close()
        continue
